        ...
        @endif
         ...
         <div class="card col-12 offset-md-2 col-md-8">
             <div class="card-header row" style="padding-top: 25px;">
                 <h5 class="card-title col-12 col-md-8">Create a Input Type</h5>
             </div>
             <div class="card-body" >
                 <form method="POST" action="/input-types/store">
                    @csrf
                    <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Input Type Name</label>
